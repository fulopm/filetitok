...
public class FileIO {
    ...
    public void encDoFinal(boolean deleteOriginal) throws IOException {
        ...
        Files.write(Paths.get(encSaveDir.toPath().toString(), Util.makeFilename(encSrcFile.getName())), BYTE_BUFFER.toByteArray());
        if (deleteOriginal) {
            encSrcFile.delete();
        }
        clearCaches();
    ...
    public void decDoFinal() throws IOException {
        ...
        Files.write(Paths.get(decSaveDir.toPath().toString(), Util.makeFilename(decSrcFile.getName())), BYTE_BUFFER.toByteArray());
        clearCaches();
    }
